...
echo Building QLcrypto.dll...
cl.exe /LD /O2 /EHsc /std:c++17 /utf-8 QLcrypto.cpp /FeQLcrypto.dll /link /implib:QLcrypto.lib bcrypt.lib kernel32.lib
...
del QLcrypto.obj QLcrypto.exp QLcrypto.lib 2>nul

echo Build succeeded: QLcrypto.dll
popd
exit /b 0
