...
echo Building QLshell.dll...
cl.exe /LD /O2 /EHsc /std:c++17 /utf-8 QLshell.cpp /FeQLshell.dll /link /implib:QLshell.lib shell32.lib user32.lib kernel32.lib
if errorlevel 1 ( echo ERROR: build failed. && exit /b 1 )
del QLshell.obj QLshell.exp QLshell.lib 2>nul
echo Build succeeded: QLshell.dll
popd
exit /b 0
