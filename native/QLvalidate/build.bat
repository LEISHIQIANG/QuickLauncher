...
echo Building QLvalidate.dll...
cl.exe /LD /O2 /EHsc /std:c++17 /utf-8 QLvalidate.cpp /FeQLvalidate.dll /link /implib:QLvalidate.lib ws2_32.lib kernel32.lib
...
del QLvalidate.obj QLvalidate.exp QLvalidate.lib 2>nul

echo Build succeeded: QLvalidate.dll
popd
exit /b 0
