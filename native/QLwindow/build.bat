...
echo Building QLwindow.dll...
cl.exe /LD /O2 /EHsc /std:c++17 /utf-8 QLwindow.cpp /FeQLwindow.dll /link /implib:QLwindow.lib psapi.lib user32.lib kernel32.lib
...
del QLwindow.obj QLwindow.exp QLwindow.lib 2>nul

echo Build succeeded: QLwindow.dll
popd
exit /b 0
