...
echo Building QLclipboard.dll...
cl.exe /LD /O2 /EHsc /std:c++17 /utf-8 QLclipboard.cpp /FeQLclipboard.dll /link /implib:QLclipboard.lib user32.lib kernel32.lib ole32.lib
if errorlevel 1 ( echo ERROR: build failed. && exit /b 1 )
del QLclipboard.obj QLclipboard.exp QLclipboard.lib 2>nul
echo Build succeeded: QLclipboard.dll
popd
exit /b 0
