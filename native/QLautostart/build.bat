...
echo Building QLautostart.dll...
cl.exe /LD /O2 /EHsc /std:c++17 /utf-8 QLautostart.cpp /FeQLautostart.dll /link /implib:QLautostart.lib advapi32.lib user32.lib kernel32.lib userenv.lib ole32.lib shell32.lib
if errorlevel 1 ( echo ERROR: build failed. && exit /b 1 )
del QLautostart.obj QLautostart.exp QLautostart.lib 2>nul
echo Build succeeded: QLautostart.dll
popd
exit /b 0
