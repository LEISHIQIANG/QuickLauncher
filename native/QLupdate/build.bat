...
echo Building QLupdate.dll...
cl.exe /LD /O2 /EHsc /std:c++17 /utf-8 QLupdate.cpp /FeQLupdate.dll /link /implib:QLupdate.lib bcrypt.lib kernel32.lib user32.lib winhttp.lib ws2_32.lib wininet.lib
if errorlevel 1 ( echo ERROR: build failed. && exit /b 1 )
del QLupdate.obj QLupdate.exp QLupdate.lib 2>nul
echo Build succeeded: QLupdate.dll
popd
exit /b 0
