...
echo Building QLsearch.dll...
cl.exe /LD /O2 /EHsc /std:c++17 /utf-8 QLsearch.cpp /FeQLsearch.dll /link /implib:QLsearch.lib normaliz.lib user32.lib kernel32.lib
...
del QLsearch.obj QLsearch.exp QLsearch.lib 2>nul

echo Build succeeded: QLsearch.dll
popd
exit /b 0
