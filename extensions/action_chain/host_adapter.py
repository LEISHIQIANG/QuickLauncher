"""Host-side adapter for the action-chain bounded context.
...
class DefaultActionChainHostAPI:
    ...
    def execute_runtime_shortcut(
        ...
        """Execute an already prepared shortcut through the injected host port."""
    ...
    def open_chain_editor(self, parent: Any, chain_data: dict[str, Any] | None) -> dict[str, Any] | None:
        """Implement the module's editor port at the host boundary."""
