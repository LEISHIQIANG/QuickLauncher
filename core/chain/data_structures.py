...
def add_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Add two data structures (supports broadcasting)."""
    return _binary_data_operation(a, b, 'add')


def sub_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Subtract two data structures (supports broadcasting)."""
    return _binary_data_operation(a, b, 'sub')


def mul_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Multiply two data structures (supports broadcasting)."""
    return _binary_data_operation(a, b, 'mul')


def div_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Divide two data structures (supports broadcasting)."""
    return _binary_data_operation(a, b, 'div')


def mod_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Modulo two data structures (supports broadcasting)."""
    return _binary_data_operation(a, b, 'mod')


def pow_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Power of two data structures (supports broadcasting)."""
    return _binary_data_operation(a, b, 'pow')


def eq_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Check equality of two data structures."""
    return _binary_data_operation(a, b, 'eq')


def ne_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Check inequality of two data structures."""
    return _binary_data_operation(a, b, 'ne')


def gt_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Check greater than."""
    return _binary_data_operation(a, b, 'gt')


def lt_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Check less than."""
    return _binary_data_operation(a, b, 'lt')


def ge_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Check greater or equal."""
    return _binary_data_operation(a, b, 'ge')


def le_data(a: Union[Item, List, Tree], b: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Check less or equal."""
    return _binary_data_operation(a, b, 'le')


def _binary_data_operation(
    a: Union[Item, List, Tree],
    b: Union[Item, List, Tree],
    operation: str
) -> Union[Item, List, Tree]:
...
def abs_data(data: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Absolute value."""
    return _unary_data_operation(data, 'abs')


def neg_data(data: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Negate."""
    return _unary_data_operation(data, 'neg')


def sqrt_data(data: Union[Item, List, Tree]) -> Union[Item, List, Tree]:
    """Square root."""
    return _unary_data_operation(data, 'sqrt')


def _unary_data_operation(data: Union[Item, List, Tree], operation: str) -> Union[Item, List, Tree]:
...
def ensure_list(data: Union[Item, List, Tree]) -> List:
...
def ensure_tree(data: Union[Item, List, Tree]) -> Tree:
...
def get_data_type(data: Union[Item, List, Tree]) -> DataType:
