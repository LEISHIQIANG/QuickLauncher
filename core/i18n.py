...
_EN_US: dict[str, str] = {
    ...
    "运行命令": "Cmd",
    "数学": "Math",
    "数字与运算": "Numbers & Operators",
    "数列与列表": "Series & Lists",
    "进制转换": "Base Conversion",
    "数字输入": "Number Input",
    "加法 (Add)": "Addition (Add)",
    "减法 (Sub)": "Subtraction (Sub)",
    "乘法 (Mul)": "Multiplication (Mul)",
    "除法 (Div)": "Division (Div)",
    "幂运算 (Pow)": "Power (Pow)",
    "取模 (Mod)": "Modulus (Mod)",
    "通用进制转换": "Base Conversion",
    "十进制转十六进制": "Decimal to Hex",
    "十六进制转十进制": "Hex to Decimal",
    "等差数列 (Series)": "Arithmetic Series (Series)",
    "等比数列": "Geometric Series",
    "列表创建": "Create List",
    "获取元素 (Item)": "List Item (Item)",
    "列表长度 (Len)": "List Length (Len)",
    "反转列表 (Rev)": "Reverse List (Rev)",
    "基本设置": "Basic",
    ...
    "加载内置命令失败：{err}": "Failed to load built-in commands: {err}",
    "CMD 命令": "CMD command",
