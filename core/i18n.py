...
_EN_US.update(
    {
        ...
        "提供内置常用快捷图标库，在图标路径失效时支持在目录中自动重定向": "Includes a built-in common icon library and can redirect automatically when icon paths become invalid",
